(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('chalk')) :
    typeof define === 'function' && define.amd ? define(['chalk'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.log = factory(global.chalk));
    ...
    var Log = /** @class */ (function () {
        ...
        Log.prototype.createLogMessage = function (type) {
            ...
            if (this.enableSymbol) {
                msgArr.push(chalk__default['default'].hex(this.colors[type])(this.symbols[type]));
            }
            if (this.enableBackgroundColor) {
                msgArr.push(chalk__default['default'].bgHex(this.colors[type])(chalk__default['default'].whiteBright(type)));
            }
            else {
                msgArr.push(chalk__default['default'].hex(this.colors[type])(type));
            }
